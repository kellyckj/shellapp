...
#define MODULE_NAME "highCastlePD"
#define LOCTEXT_NAMESPACE "FhighCastlePDModule"

void FhighCastlePDModule::StartupModule()
{
...
void FhighCastlePDModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FhighCastlePDModule, highCastlePD)
