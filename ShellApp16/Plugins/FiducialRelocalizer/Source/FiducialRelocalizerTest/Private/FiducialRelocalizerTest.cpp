...
#include "FiducialRelocalizerTest.h"
#include "logging.hpp"
...
#define MODULE_NAME "FiducialRelocalizerTest"
#define LOCTEXT_NAMESPACE "FFiducialRelocalizerTestModule"

void FFiducialRelocalizerTestModule::StartupModule()
{
...
void FFiducialRelocalizerTestModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FFiducialRelocalizerTestModule, FiducialRelocalizerTest)
